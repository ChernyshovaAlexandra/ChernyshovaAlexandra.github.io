function Fighter() {
    ...
    this.monsters = ['url("assets/images/monster-1.png") no-repeat center', 'url("assets/images/monster-2.png") no-repeat center', 'url("assets/images/monster-3.png")  no-repeat center', 'url("assets/images/monster-4.png")  no-repeat center'];
...
Fighter.prototype.greetMonster = function () {
    ...
    this.monsterPerson = document.getElementsByClassName('monster-icon')[0];
    ...
    this.monsterPerson.style.background = this.monsters[this.getRandomInt(0, this.monsters.length-1)];
};
...
Fighter.prototype.turn = function (action) {
    ...
    this.health[unit] -= this.level * 10;
